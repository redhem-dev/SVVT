...
public class MechanicalAsusKeyboard {
    ...
    @Test
    void mechanicalAsusKeyboardTest2 () throws InterruptedException {
        ...
        keyboards.click();
        Thread.sleep(1500);
        WebElement asusRadio = webDriver.findElement(By.xpath("//*[@id=\"sidebar-widget\"]/div/form/div/ul/label[2]/input"));
        js.executeScript("arguments[0].click()", asusRadio);
        WebElement mechanicalRadio = webDriver.findElement(By.xpath("//*[@id=\"sidebar-widget\"]/div/form/ul/li[3]/label[1]/input"));
        js.executeScript("arguments[0].scrollIntoView(true)", mechanicalRadio);
        Thread.sleep(1500);
        ...
        /*
    Test made to assure that the only Asus Mechanical Keyboard is named -> ASUS Mehanička Gaming Tastatura Rog Falchion Ace.
    After wrongful filtration, it is impossible to find this product.
     */
    }
